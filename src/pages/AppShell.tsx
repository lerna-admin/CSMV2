...
export default function AppShell() {
  ...
  const [activeTab, setActiveTab] = useState<StudioTab>('site');
  ...
  function publishSite() {
    // Regla: cada usuario solo publica un sitio (su proyecto unico).
  ...
  function saveSharedTemplate() {
    ...
    const template = {
      ...
      // Plantillas compartidas para toda la plataforma.
      publicTemplate: true,
    } as const;
    ...
    <main className="app-shell">
      <header className="topbar">
        ...
        <div className="topbar-actions">
          <button type="button" onClick={() => { clearSession(); location.href = '/CSMV2/'; }}>Cerrar sesion</button>
        </div>
      </header>
      ...
      <section className="workspace">
        <div className="workspace-head">
          <h2>Studio</h2>
          <p>Cada usuario puede publicar un solo sitio (su proyecto unico).</p>
          <div className="actions">
            <button type="button" onClick={() => setActiveTab('site')}>Editar sitio</button>
            <button type="button" onClick={() => setActiveTab('template')}>Crear plantilla</button>
          </div>
        </div>
        ...
        {activeTab === 'template' && (
          <section className="template-studio">
            ...
            <p>Este creador genera plantillas compartidas que otros usuarios pueden usar para crear sus sitios.</p>
